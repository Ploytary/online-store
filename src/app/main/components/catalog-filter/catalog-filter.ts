...
export class CatalogFilter extends BaseComponent {
  ...
  constructor(props: ComponentProps = {}) {
    ...
    const titleComponent = new BaseComponent({ tagName: 'h3', classList: ['catalog__filter-title'], content: 'Filters'});
    const resetLinkComponent = new BaseComponent({ tagName: 'a', classList: ['catalog__filter-reset-link', 'link'], content: 'Reset'});
