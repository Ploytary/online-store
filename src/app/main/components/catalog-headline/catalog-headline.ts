...
export class CatalogHeadline extends BaseComponent {
  constructor(props: ComponentProps = {}) {
    ...
    const searchInputComponent = new Input({
      classList: ['input--search', 'catalog__headline-input'],
      placeholder: 'Items 1-6 of 61',
    });
    ...
    const showCountComponent = new Select({
      selectOptions: ['Show: 6 per page', 'Show: 12 per page', 'Show: 18 per page'],
    });
