...
export class PageFooter extends BaseComponent {
  ...
  constructor(props: ComponentProps = {}) {
    ...
    const githubPloytaryIcon = new IconLink({width: 32, height: 32, SVGIconID: 'github-icon', href: 'https://github.com/Ploytary', content: 'Ploytary github'});
    const githubMrdmitrijIcon = new IconLink({width: 32, height: 32, SVGIconID: 'github-icon', href: 'https://github.com/mrdmitrij', content: 'mrdmitrij github'});
    const ploytaryBarge = new BaseComponent({tagName: 'span', classList: ['page-footer__autors-barge'], content: '@Ploytary'});
    const mrdmitrijBarge = new BaseComponent({tagName: 'span', classList: ['page-footer__autors-barge'], content: '@mrdmitrij'});
    ...
    const schoolIcon = new IconLink({width: 93, height: 30, SVGIconID: 'rs-school-icon', href: 'https://rs.school/', content: 'RS-School'});
    const schoolBarge = new BaseComponent({tagName: 'span', classList: ['page-footer__school-barge'], content: 'RS School'});
    ...
    const logo = new IconLink({width: 192, height: 45, SVGIconID: 'site-logo', href: '#home', content: 'Site logo', classList: ['page-footer__logo']});
    ...
    const rightColumnTitle = new BaseComponent({tagName: 'h3', classList: ['page-footer__menu-list-title'], content: 'Contacts'});
    const email = new BaseComponent({tagName: 'p', classList: ['page-footer__contacts-item'], content: 'Agustina.Jakubowski63@hotmail.com'});
    const phone = new BaseComponent({tagName: 'p', classList: ['page-footer__contacts-item'], content: '(514) 243-189176'});
    const address = new BaseComponent({tagName: 'p', classList: ['page-footer__contacts-item'], content: '16032 Tromp Overpas, Charlotte, Idaho, 65644-2998'});
